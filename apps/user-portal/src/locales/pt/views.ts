...
export const views: Views = {
    components: {
        ...
        footer: {
            copyright: "Servidor de Identidade cic © {{year}}"
        },
        linkedAccounts: {
            accountTypes: {
                local: {
        ...
        privacy: {
            about: {
                description: "O cic Identity Server (referido como \"cic IS\" nesta política) é um servidor de " +
                    "gerenciamento e titularidade de identidades de código aberto baseado em padrões e " +
                    "especificações abertos.",
                heading: "Sobre o servidor de identidade cic"
            },
            privacyPolicy: {
                collectionOfPersonalInfo: {
                    description: {
                        list1: {
                            0: "O cic IS usa seu endereço IP para detectar tentativas suspeitas de login na sua " +
                                "conta.",
                            1: "O cic IS usa atributos como seu nome, sobrenome, etc., para fornecer uma " +
                                "experiência rica e personalizada ao usuário.",
                            2: "O cic IS usa suas perguntas e respostas de segurança apenas para permitir a " +
                                "recuperação da conta."
                        },
                        para1: "O cic IS coleta suas informações apenas para atender aos seus requisitos de " +
                            "acesso. Por exemplo:"
                    },
                    ...
                    trackingTechnologies: {
                        description: {
                            ...
                            para1: "O cic IS coleta suas informações por:"
                        },
                        heading: "Tecnologias de rastreamento"
                    }
                },
                description: {
                    para1: "Esta política descreve como o cic IS captura suas informações pessoais, os propósitos " +
                    ...
                    para2: "Observe que esta política é apenas para referência e é aplicável ao software como um " +
                        "roduto. A cic e seus desenvolvedores não têm acesso às informações mantidas no " +
                        "cic IS. Consulte a seção <1> isenção de responsabilidade </1> para obter mais informações.",
                    para3: "Entidades, organizações ou indivíduos que controlam o uso e a administração do cic IS " +
                ...
                disclaimer: {
                    description: {
                        list1: {
                            0: "O cic, seus funcionários, parceiros e afiliados não têm acesso e não exigem, " +
                                "armazenam, processam ou controlam nenhum dos dados, incluindo dados pessoais " +
                                "contidos no cic IS. Todos os dados, incluindo dados pessoais, são controlados " +
                                "e processados ​​pela entidade ou indivíduo que executa o cic IS. O cic, seus " +
                                ...
                                "O cic não fornece nenhuma garantia ou assume qualquer responsabilidade ou " +
                                "obrigação relacionada à legalidade ou à maneira e aos propósitos pelos quais " +
                                "o cic IS é usado por essas entidades ou pessoas.",
                            1: "Esta política de privacidade é para fins informativos da entidade ou pessoas que " +
                                "executam o cic IS e define os processos e a funcionalidade contidos no cic IS em " +
                                "relação à proteção de dados pessoais. É de responsabilidade das entidades e " +
                                "pessoas que executam o cic IS criar e administrar suas próprias regras e " +
                                ...
                                "cic IS para obter sua própria política de privacidade para obter detalhes sobre " +
                ...
                disclosureOfPersonalInfo: {
                    description: "O cic IS apenas divulga informações pessoais para os aplicativos relevantes " +
                        "(também conhecidos como Provedor de Serviços) registrados no cic IS. Esses aplicativos " +
                    ...
                    legalProcess: {
                        description: "Observe que a organização, entidade ou indivíduo que executa o cic IS " +
                ...
                moreInfo: {
                    changesToPolicy: {
                        description: {
                            para1: "As versões atualizadas do cic IS podem conter alterações nesta política e " +
                            ...
                            para2: "A organização que executa o cic IS pode revisar a Política de Privacidade de " +
                                "tempos em tempos. Você pode encontrar a política de governo mais recente com o " +
                                "respectivo link fornecido pela organização que executa o cic IS. " +
                    ...
                    contactUs: {
                        description: {
                            para1: "Entre em contato com o cic se tiver alguma dúvida ou preocupação em relação " +
                    ...
                    yourChoices: {
                        description: {
                            para1: "Se você já possui uma conta de usuário no cic IS, tem o direito de desativar " +
                ...
                storageOfPersonalInfo: {
                    ...
                    howLong: {
                        description: {
                            ...
                            para1: "O cic IS retém seus dados pessoais, desde que você seja um usuário ativo do " +
                            ...
                            para2: "O cic IS pode manter segredos de hash para fornecer um nível adicional de " +
                    ...
                    requestRemoval: {
                        description: {
                            ...
                            para2: "Além disso, você pode solicitar para anonimizar todos os vestígios de suas " +
                                "atividades que o cic IS possa ter retido em logs, bancos de dados ou " +
                    ...
                    where: {
                        description: {
                            para1: "O cic IS armazena suas informações pessoais em bancos de dados protegidos. " +
                                "O cic IS exerce medidas adequadas de segurança aceitas pelo setor para proteger " +
                                "o banco de dados em que suas informações pessoais são mantidas. O cic IS como " +
                                "produto não transfere ou compartilha seus dados com terceiros ou locais.",
                            para2: "O cic IS pode usar criptografia para manter seus dados pessoais com um nível " +
                ...
                useOfPersonalInfo: {
                    description: {
                        list1: {
                            0: "Para fornecer uma experiência personalizada ao usuário. O cic IS usa seu nome e " +
                            ...
                            1: "Para proteger sua conta contra acesso não autorizado ou possíveis tentativas de " +
                                "hackers. O cic IS usa cabeçalhos HTTP ou TCP / IP para esse fim.",
                            2: "Derivar dados estatísticos para fins analíticos nas melhorias de desempenho do " +
                                "sistema. O cic IS não manterá nenhuma informação pessoal após cálculos " +
                                "estatísticos. Portanto, o relatório estatístico não tem como identificar " +
                                "uma pessoa individualmente."
                        },
                        para1: "O cic IS usará suas informações pessoais apenas para os fins para os quais " +
                            "foram coletadas (ou para um uso identificado como consistente com esse objetivo).",
                        para2: "O cic IS usa suas informações pessoais apenas para os seguintes fins.",
                        subList1: {
                            heading: "Isso inclui:",
                            list: {
                                0: "endereço de IP",
                ...
                whatIsPersonalInfo: {
                    description: {
                        ...
                        para1: "O cic IS considera qualquer coisa relacionada a você e pela qual você pode ser " +
                            "identificado como suas informações pessoais. Isso inclui, mas não se limita a:",
                        para2: "No entanto, o cic IS também coleta as seguintes informações que não são " +
        ...
        profile: {
            fields: {
                ...
                homePhone: "Número de telefone residencial",
    ...
    pages: {
        ...
        privacy: {
            subTitle: "",
            title: "Política de Privacidade do Servidor de Identidade cic"
        },
        security: {
