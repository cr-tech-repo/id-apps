...
export const views: Views = {
    components: {
        ...
        privacy: {
            about: {
                description:
                    "cic Identity Server (referred to as “cic IS” within this policy) is an open source " +
            ...
            privacyPolicy: {
                collectionOfPersonalInfo: {
                    description: {
                        list1: {
                            ...
                            1:
                                "cic IS uses attributes like your first name, last name, etc., to provide a rich and" +
                ...
                description: {
                    para1:
                        "This policy describes how cic IS captures your personal information, the purposes of" +
                    ...
                    para2:
                        ...
                        "as a product. cic and its developers have no access to the information held within " +
                        "cic IS. Please see the <1>disclaimer</1> section for more information.",
                    para3:
                        "Entities, organizations or individuals controlling the use and administration of cic IS " +
                ...
                disclaimer: {
                    description: {
                        list1: {
                            0:
                                "cic, its employees, partners, and affiliates do not have access to and do not " +
                ...
                disclosureOfPersonalInfo: {
                    description:
                        "cic IS only discloses personal information to the relevant applications (also " +
                    ...
                    legalProcess: {
                        description:
                            "Please note that the organization, entity or individual running cic IS may " +
                ...
                moreInfo: {
                    changesToPolicy: {
                        description: {
                            para1:
                                "Upgraded versions of cic IS may contain changes to this policy and " +
                            ...
                            para2:
                                "The organization running cic IS may revise the Privacy Policy from time to " +
                    ...
                    contactUs: {
                        description: {
                            para1:
                                "Please contact cic if you have any question or concerns regarding this privacy " +
                                "policy."
                        },
                        heading: "Contact us"
                    },
                    ...
                    yourChoices: {
                        description: {
                            para1:
                                "If you are already have a user account within cic IS, you have the right to " +
                ...
                storageOfPersonalInfo: {
                    ...
                    howLong: {
                        description: {
                            ...
                            para1:
                                "cic IS retains your personal data as long as you are an active user of our " +
                                "system. You can update your personal data at any time using the given self-care " +
                                "user portals.",
                            para2:
                                "cic IS may keep hashed secrets to provide you with an added level of security. " +
                                "This includes:"
                        },
                    ...
                    where: {
                        description: {
                            para1:
                                "cic IS stores your personal information in secured databases. cic IS " +
                            ...
                            para2:
                                "cic IS may use encryption to keep your personal data with an added level " +
                                "of security."
                        },
                ...
                useOfPersonalInfo: {
                    description: {
                        list1: {
                            0:
                                "To provide you with a personalized user experience. cic IS uses your name and " +
                        ...
                        para1:
                            "cic IS will only use your personal information for the purposes for which it was " +
                ...
                whatIsPersonalInfo: {
                    description: {
                        ...
                        para1:
                            "cic IS considers anything related to you, and by which you may be identified, as " +
    ...
    pages: {
        ...
        privacy: {
            subTitle: "",
            title: "cic Identity Server Privacy Policy"
        },
        security: {
