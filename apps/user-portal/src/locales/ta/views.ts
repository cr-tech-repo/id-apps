...
export const views: Views = {
    components: {
        ...
        privacy: {
            about: {
                description:
                    "cic Identity Server (இக் கொள்கையில் “cic IS” என குறிப்பிடப்படும்) திறந்த தரநிலைகள் மற்றும் குறிப்புகளை " +
                    "அடிப்படையாகக் கொண்ட ஒரு திறந்த மூல அடையாள முகாமைத்துவம் மற்றும் உரிமம் வழங்கி ஆகும்.",
                heading: "cic Identity Server ஐ பற்றி"
            },
            privacyPolicy: {
                collectionOfPersonalInfo: {
                    description: {
                        list1: {
                            0:
                                ...
                                " cic IS உங்கள் IP முகவரியினை பயன்படுத்துகின்றது.",
                            1:
                                "உங்களது முதற் பெயர், இறுதிப் பெயர் போன்ற விவரங்களை cic IS உங்களுக்கு சிறப்பான, தனிப்பட்ட " +
                                "அனுபவத்தை தர பயன்படுத்துகின்றது.",
                            2:
                                "உங்களது கணக்கினை மீட்க மட்டுமே cic IS உங்களது பாதுகாப்பு வினாக்களையும் அவற்றிற்கான " +
                                "விடைகளையும் பயன்படுத்துகின்றது."
                        },
                        para1:
                            "உங்கள் அணுகல் தேவைகளை பூர்த்தி செய்ய மட்டுமே cic IS உங்களது தகவல்களை சேகரிக்கின்றது." +
                            "உதாரணத்திற்கு"
                    },
                    ...
                    trackingTechnologies: {
                        description: {
                            ...
                            para1: "cic IS உங்கள் தகவல்களை பின்வருமாறு சேகரிக்கின்றது:"
                        },
                ...
                description: {
                    para1:
                        "இக் கொள்கை, cic IS எவ்வாறு உங்கள் தகவல்களை பெறுகின்றது, தகவல்களை பெறும் நோக்கம், மற்றும் " +
                    ...
                    para2:
                        ...
                        "cic இனாலோ அதனது மென்பொருள் பொறியியலாளர்களினாலோ cic IS இல் வைத்திருக்கப்பட்டிருக்கும் " +
                        "தகவல்களை பெற முடியாது. மேலதிக தகவல்களுக்கு <i>பொறுப்புத் துறப்பு</i> பகுதியினை பார்வையிடவும்.",
                    para3:
                        "cic IS ஐ நிர்வாகம் செய்யும் அல்லது அதனது பாவனையை கட்டுபடுத்தும் நிறுவனங்களோ, அல்லது தனிப்பட்ட " +
                ...
                disclaimer: {
                    description: {
                        list1: {
                            0:
                                "cic இற்கு, அதன் ஊழியர்களிற்கு, கூட்டாளர்களிற்கு மற்றும் துணை நிறுவனங்களிற்கு cic " +
                                ...
                                "தனிப்பட்ட தரவு உட்பட அனைத்து தரவும் cic IS ஐ இயக்கும் நிறுவனம் அல்லது தனிநபரால் " +
                                "கட்டுப்படுத்தப்பட்டு செயலாக்கப்படுகிறது. cic, அதன் பணியாளர்கள், கூட்டாளர்கள் " +
                                "மற்றும் துணை நிறுவனங்கள் எந்தவொரு தரவு தனியுரிமை விதிமுறைகளின் அர்த்தத்திற்குட்பட்ட ஒரு தரவு " +
                                "செயலி அல்லது தரவுக் கட்டுப்படுத்தி அல்ல. cic எந்தவொரு உத்தரவாதத்தையும் வழங்காது " +
                                "என்பதுடன் நிறுவனங்களோ, தனி நபர்களோ cic IS ஐ பயன்படுத்தும் முறை மற்றும் நோக்கம், " +
                                "அத்துடன் அவற்றின் சட்டபூர்வ தன்மை என்பனவற்றிற்கு எவ்வித பொறுப்பும் எடுக்காது.",
                            1:
                                "இந்த தனியுரிமைக் கொள்கை cic IS ஐ இயக்கும் நிறுவனம் அல்லது நபர்களின் தகவல் " +
                                "நோக்கங்களுக்காகவும், தனிப்பட்ட தரவு பாதுகாப்பு தொடர்பாக cic IS இல் உள்ள " +
                                ...
                                "உருவாக்கி நிர்வகிப்பது cic IS ஐ இயக்கும் நிறுவனங்கள் மற்றும் நபர்களின் " +
                                ...
                                "நிர்வகிக்கும் விவரங்களுக்கு பயனர்கள் அதன் சொந்த தனியுரிமைக் கொள்கைக்காக நிறுவனம் அல்லது cic IS ஐ " +
                ...
                disclosureOfPersonalInfo: {
                    description:
                        "cic IS உடன் பதிவுசெய்யப்பட்ட தொடர்புடைய செயலிகளிற்கு (சேவை வழங்குநர் என்றும் " +
                        "அழைக்கப்படுகிறது) மட்டுமே தனிப்பட்ட தகவல்களை cic IS வெளியிடுகிறது. இந்த செயலிகள் உங்கள் " +
                    ...
                    legalProcess: {
                        description:
                            "cic ISஐ இயக்கும் அமைப்பு, நிறுவனம் அல்லது தனிநபர் உங்கள் தனிப்பட்ட தகவல்களை உங்கள் " +
                ...
                moreInfo: {
                    changesToPolicy: {
                        description: {
                            para1:
                                "cic IS இன் மேம்படுத்தப்பட்ட பதிப்புகள் இந்தக் கொள்கையில் மாற்றங்களைக் கொண்டிருக்கலாம் " +
                            ...
                            para2:
                                "cic IS ஐ இயக்கும் அமைப்பு அவ்வப்போது தனியுரிமைக் கொள்கையைத் " +
                                "திருத்தக்கூடும். cic IS ஐ இயக்கும் அமைப்பு வழங்கிய அந்தந்த இணைப்பைக் கொண்டு மிக " +
                    ...
                    contactUs: {
                        description: {
                            para1:
                                ...
                                "வருத்தங்கள் இருந்தால் cic ஐ தொடர்பு கொள்ளவும்."
                        },
                    ...
                    yourChoices: {
                        description: {
                            para1:
                                "cic IS க்குள் உங்களிடம் ஏற்கனவே ஒரு பயனர் கணக்கு இருந்தால், இந்த " +
                ...
                storageOfPersonalInfo: {
                    ...
                    howLong: {
                        description: {
                            ...
                            para1:
                                "நீங்கள் எங்கள் சேவையின் செயலிலுள்ள பயனராக இருக்கும் வரை cic IS உங்கள் தனிப்பட்ட " +
                            ...
                            para2:
                                "cic IS உங்களுக்கு கூடுதல் பாதுகாப்பு அளிக்க சுருக்கப்பட்ட ரகசியங்களை வைத்திருக்கலாம். " +
                    ...
                    requestRemoval: {
                        description: {
                            para1:
                                ...
                                "சூப்பர் நிர்வாகி.",
                            para2:
                                "கூடுதலாக, பதிவுகள், தரவுத்தளங்கள் அல்லது பகுப்பாய்வு சேமிப்பகத்தில் cic IS தக்கவைத்துள்ள " +
                    ...
                    where: {
                        description: {
                            para1:
                                "cic IS உங்கள் தனிப்பட்ட தகவல்களை பாதுகாப்பான தரவுத்தளங்களில் சேமிக்கிறது. உங்கள் " +
                                "தனிப்பட்ட தகவல்கள் வைத்திருக்கும் தரவுத்தளத்தைப் பாதுகாக்க cic IS சரியான துறையில் " +
                                "ஏற்றுக்கொள்ளப்பட்ட பாதுகாப்பு நடவடிக்கைகளைப் பயன்படுத்துகிறது. cic IS ஒரு " +
                                "தயாரிப்பாக உங்கள் தரவை எந்த மூன்றாம் தரப்பினருடனோ அல்லது இருப்பிடங்களுடனோ மாற்றவோ " +
                                "பகிரவோ இல்லை.",
                            para2:
                                "cic IS உங்கள் தனிப்பட்ட தரவை கூடுதல் பாதுகாப்புடன் வைத்திருக்க குறியாக்கத்தைப் " +
                                "பயன்படுத்தலாம்."
                        },
                ...
                useOfPersonalInfo: {
                    description: {
                        list1: {
                            0:
                                "தனிப்பயனாக்கப்பட்ட பயனர் அனுபவத்தை உங்களுக்கு வழங்க, cic IS உங்கள் பெயரைப் " +
                            ...
                            1:
                                ...
                                "பாதுகாக்க, cic IS இந்த நோக்கத்திற்காக HTTP அல்லது TCP / IP தலைப்புகளைப் " +
                                "பயன்படுத்துகிறது.",
                            2:
                                "கணினி செயல்திறன் மேம்பாடுகள் குறித்த பகுப்பாய்வு நோக்கங்களுக்காக புள்ளிவிவர தரவைப் " +
                                "பெறப்படுகின்றது. cic IS புள்ளிவிவர கணக்கீடுகளுக்குப் பிறகு எந்த தனிப்பட்ட " +
                                "தகவலையும் வைத்திருக்காது. எனவே, புள்ளிவிவர அறிக்கையில் ஒரு தனி நபரை அடையாளம் காண வழி இல்லை."
                        },
                        para1:
                            "cic IS உங்கள் தனிப்பட்ட தகவல்களை சேகரிக்கப்பட்ட நோக்கங்களுக்காக மட்டுமே பயன்படுத்தும் " +
                            "(அல்லது அந்த நோக்கத்துடன் ஒத்துப்போகும் அடையாளம் காணப்பட்ட பயன்பாட்டிற்கு).",
                        para2: "cic IS உங்கள் தனிப்பட்ட தகவல்களை பின்வரும் நோக்கங்களுக்காக மட்டுமே பயன்படுத்துகிறது.",
                        subList1: {
                        ...
                        subList2: {
                            heading: "cic IS பின்வருவனவற்றை பயன்படத்தலாம்:",
                            list: {
                ...
                whatIsPersonalInfo: {
                    description: {
                        ...
                        para1:
                            "உங்கள் தனிப்பட்ட தகவலாக உங்களை அடையாளம் காணும் எதையும் cic IS கருதுகிறது. " +
                            "இது பின்வருவனவற்றை உள்ளடக்குகிறது, ஆனால் இவை மட்டும் அல்ல:",
                        para2:
                            "இருப்பினும், cic IS தனிப்பட்ட தகவல்களாக கருதப்படாத பின்வரும் தகவல்களையும் " +
        ...
        profile: {
            fields: {
                ...
                mail: "தொழில் மின்னஞ்சல் முகவரி",
                generic: {
                    default: "ஐச் சேருங்கள் {{fieldName}}"
                },
                sn: "இறுதிப்பெயர்",
                givenName: "முதற்பெயர்",
                phoneNumbers: "தொலைபேசி இலக்கம்",
                mobile: "வீட்டு தொலைபேசி இலக்கம்",
                homePhone: "கையடக்க தொலைபேசி இலக்கம்",
    ...
    pages: {
        ...
        privacy: {
            subTitle: "",
            title: "cic Identity Server தனியுரிமைக் கொள்கை"
        },
        security: {
