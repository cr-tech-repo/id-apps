                    ...
                    <List.Content>
                        <Grid padded>
                            ...
                            <Grid.Row columns={ 2 }>
                                ...
                                <Grid.Column width={ 11 }>
                                    <List.Description>{ userSession.originIP }</List.Description>
                                </Grid.Column>
                            </Grid.Row>
                            {
                                device.vendor
                            ...
                            {
                                userSession.appId && userSession.appId.length > 0
                                    ? (
                                        <Grid.Row columns={ 2 }>
                                            <Grid.Column width={ 5 }>
                            ...
                            <Grid.Row columns={ 2 }>
                                ...
                                <Grid.Column width={ 11 }>
                                    <List.Description>
                                       { moment(userSession.issuedOn).format("LLLL") }
                                    </List.Description>
                                </Grid.Column>
                            </Grid.Row>
                            <Grid.Row columns={ 2 }>
