...
import {Attributes, ProfileSchema, UserSession} from "../../models";
        ...
        <List divided verticalAlign="middle" className="main-content-inner">
            {
                ...
                && userSessions.length > 0
                    ? userSessions.map((userSession, index) => {
                        ...
                        const url = userSession.attributes.filter((schema: Attributes) => {
                            return schema.name === "urn:ibm:OIDC:claim:value:deviceType";
                        });
                        userAgentParser.uaString = url[0].values[0];
                        return (
