...
import {SidePanelItems} from "../components/side-panel/side-panel-items";
...
export const InnerPageLayout: React.FunctionComponent<InnerPageLayoutProps> = (
    ...
    return (
        <>
            ...
            <AppHeader onSidePanelToggleClick={ handleSidePanelToggleClick } type="desktop" onSidePanelItemClick={ handleSidePanelItemClick } headerHeight={ headerHeight } />
