...
module.exports = (env) => {
     ...
     */
    const serverHostDefault = "https://milogindev.ice.ibmcloud.com";
    ...
    const clientIdDefault = "4b6d414f-abb6-4db7-9112-7afc561c8e86";
    ...
    const faviconImage = path.resolve(__dirname, "node_modules", "@cicis/theme/lib/assets/images/favicon.ico");
    const titleText = "MILogin";
        ...
        if (isProd) {
            return new HtmlWebpackPlugin({
                ...
                importUtil: "<%@ page import=\"" +
                                "static org.cic.carbon.identity.core.util.IdentityUtil.getServerURL\" %>",
                importTenantPrefix: "<%@ page import=\"static org.cic.carbon.utils.multitenancy." +
                    "MultitenantConstants.TENANT_AWARE_URL_PREFIX\"%>",
                importSuperTenantConstant: "<%@ page import=\"static org.cic.carbon.utils.multitenancy." +
    ...
    return {
        ...
        watchOptions: {
            ignored: [/node_modules([\\]+|\/)+(?!@cicis)/, /build/]
        },
        devServer: {
            https: true,
        ...
        plugins: [
            ...
            new CopyWebpackPlugin([
                {
                    context: path.join(__dirname, "node_modules", "@cicis", "theme"),
                    from: "lib",
                    to: "libs/styles/css"
                },
                // TODO: Removed temporally. Currently we don't use it in runtime
                // {
                //     context: path.resolve(__dirname, 'node_modules', '@cicis', 'theme'),
                //     from: 'src',
