...
import { SearchUtils } from "@cicis/core/utils";
import { Field, Forms } from "@cicis/forms";
import { AdvancedSearch } from "@cicis/react-components";
 ...
 */
interface DialectSearchPropsInterface {
 ...
 * @return {JSX.Element}
 */
export const DialectSearch: FunctionComponent<DialectSearchPropsInterface> = (
    props: DialectSearchPropsInterface
): JSX.Element => {
    ...
    const filterAttributeOptions = [
        { value: "dialectURI", text: "Dialect URI" }
    ];
