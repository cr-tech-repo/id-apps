...
export const views: Views = {
    components: {
        ...
        footer: {
            copyright: "cic Identity Server © {{year}}"
        },
        privacy: {
            about: {
                description: "cic Identity Server (referred to as “cic IS” within this policy) is an open source " +
                    "Identity Management and Entitlement Server that is based on open standards and specifications.",
                heading: "About cic Identity Server"
            },
            privacyPolicy: {
                collectionOfPersonalInfo: {
                    description: {
                        list1: {
                            0: "cic IS uses your IP address to detect any suspicious login attempts to your account.",
                            1: "cic IS uses attributes like your first name, last name, etc., to provide a rich and" +
                                " personalized user experience.",
                            2: "cic IS uses your security questions and answers only to allow account recovery."
                        },
                        para1: "cic IS collects your information only to serve your access requirements. For example:"
                    },
                    ...
                    trackingTechnologies: {
                        description: {
                            ...
                            para1: "cic IS collects your information by:"
                        },
                        heading: "Tracking Technologies"
                    }
                },
                description: {
                    para1: "This policy describes how cic IS captures your personal information, the purposes of" +
                    ...
                    para2: "Please note that this policy is for reference only, and is applicable for the software " +
                        ...
                        "cic IS. Please see the <1>disclaimer</1> section for more information.",
                    para3: "Entities, organizations or individuals controlling the use and administration of cic IS " +
                ...
                disclaimer: {
                    description: {
                        list1: {
                            0: "cic, its employees, partners, and affiliates do not have access to and do not " +
                                "require, store, process or control any of the data, including personal data " +
                                "contained in cic IS. All data, including personal data is controlled and " +
                                "processed by the entity or individual running cic IS. cic, its employees partners " +
                                "and affiliates are not a data processor or a data controller within the meaning of " +
                                "any data privacy regulations. cic does not provide any warranties or undertake any " +
                                "responsibility or liability in connection with the lawfulness or the manner and " +
                                "purposes for which cic IS is used by such entities or persons.",
                            1: "This privacy policy is for the informational purposes of the entity or persons " +
                                "running cic IS and sets out the processes and functionality contained within " +
                                "cic IS regarding personal data protection. It is the responsibility of entities " +
                                "and persons running cic IS to create and administer its own rules and processes " +
                                ...
                                "the entity or persons running cic IS for its own privacy policy for details " +
                ...
                disclosureOfPersonalInfo: {
                    description: "cic IS only discloses personal information to the relevant applications (also " +
                        "known as Service Provider) that are registered with cic IS. These applications are " +
                    ...
                    legalProcess: {
                        description: "Please note that the organization, entity or individual running cic IS may " +
                ...
                moreInfo: {
                    changesToPolicy: {
                        description: {
                            para1: "Upgraded versions of cic IS may contain changes to this policy and " +
                            ...
                            para2: "The organization running cic IS may revise the Privacy Policy from time to " +
                                "time. You can find the most recent governing policy with the respective link " +
                                "provided by the organization running cic IS. The organization will notify " +
                    ...
                    contactUs: {
                        description: {
                            para1: "Please contact cic if you have any question or concerns regarding this privacy " +
                                "policy."
                        },
                        heading: "Contact us"
                    },
                    ...
                    yourChoices: {
                        description: {
                            para1: "If you are already have a user account within cic IS, you have the right to " +
                ...
                storageOfPersonalInfo: {
                    ...
                    howLong: {
                        description: {
                            ...
                            para1: "cic IS retains your personal data as long as you are an active user of our " +
                                "system. You can update your personal data at any time using the given self-care " +
                                "user portals.",
                            para2: "cic IS may keep hashed secrets to provide you with an added level of security. " +
                                "This includes:"
                        },
                    ...
                    requestRemoval: {
                        description: {
                            ...
                            para2: "Additionally, you can request to anonymize all traces of your activities " +
                                "that cic IS may have retained in logs, databases or analytical storage."
                        },
                        heading: "How to request removal of your personal information"
                    },
                    where: {
                        description: {
                            para1: "cic IS stores your personal information in secured databases. cic IS " +
                                "exercises proper industry accepted security measures to protect the database " +
                                "where your personal information is held. cic IS as a product does not transfer " +
                                "or share your data with any third parties or locations.",
                            para2: "cic IS may use encryption to keep your personal data with an added level " +
                                "of security."
                        },
                ...
                useOfPersonalInfo: {
                    description: {
                        list1: {
                            0: "To provide you with a personalized user experience. cic IS uses your name and " +
                            ...
                            1: "To protect your account from unauthorized access or potential hacking attempts. " +
                                "cic IS uses HTTP or TCP/IP Headers for this purpose.",
                            2: "Derive statistical data for analytical purposes on system performance improvements. " +
                                "cic IS will not keep any personal information after statistical calculations. " +
                                "Therefore, the statistical report has no means of identifying an individual person."
                        },
                        para1: "cic IS will only use your personal information for the purposes for which it was " +
                            "collected (or for a use identified as consistent with that purpose).",
                        para2: "cic IS uses your personal information only for the following purposes.",
                        subList1: {
                ...
                whatIsPersonalInfo: {
                    description: {
                        ...
                        para1: "cic IS considers anything related to you, and by which you may be identified, as " +
                            "your personal information. This includes, but is not limited to:",
                        para2: "However, cic IS also collects the following information that is not considered " +
    ...
    sections: {
        changePassword: {
            ...
            description: "Set user's temporary password",
