...
import { getProfileInfo } from "@cicis/core/api";
import { AuthReducerStateInterface, ChildRouteInterface, RouteInterface } from "@cicis/core/models";
import { ContextUtils } from "@cicis/core/utils";
import { Footer, Header, Logo, ProductBrand, SidePanel } from "@cicis/react-components";
                    ...
                    userDropdownInfoAction={ (
                        <Button
                            ...
                            onClick={
                                (): void => {
                                    window.open(
                                        `${GlobalConfig.userPortalBaseName}/${GlobalConfig.userPortalBaseName}`
                                    );
                                }
                            }
                        >
