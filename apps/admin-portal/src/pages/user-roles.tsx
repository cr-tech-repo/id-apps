...
export const UserRoles = (): ReactElement => {
    ...
    const getRoleList = (limit?: number, offset?: number, filter?: string) => {
        getGroupsList(limit, offset, undefined/*'urn:ietf:params:scim:schemas:extension:ibm:2.0:Group:groupType eq "standard"'*/).then((response)=> {
    ...
    useEffect(() => {
        getRoleList(listItemLimit, listOffset, null);
    },[ listOffset, listItemLimit ]);

/*    useEffect(() => {
        getRoleList(undefined,undefined,undefined);
