            ...
            plugins: [
                ...
                new RewriteImportPlugin({
                    paths: {
                        ...
                        "../../cic.config": path.join(themesDir, theme, 'cic.config')
                    }
                })
            ]
        };
...
const writeFile = (theme, file, content) => {
    fs.writeFileSync(path.join(buildDir, "cic-" + theme + file), content, (error) => {
        console.error("cic-" + theme + file + " generation failed.");
        console.error(error);
    });

    console.info("cic-" + theme + file + " generated.");
};
